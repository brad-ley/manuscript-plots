...
FOLDER = '/Volumes/GoogleDrive/My Drive/Research/protein-dynamics/manuscripts/methods 2022/data/AsLOV DEER/2.8 nm ruler'
def plot(folder):
    ...
    for exp in expts:
        ...
        axin.plot(exp_db['time (Βs)'], exp_db['Data'] - exp_db['Offset'], color=color, lw=lw, label=label, ls=style)
